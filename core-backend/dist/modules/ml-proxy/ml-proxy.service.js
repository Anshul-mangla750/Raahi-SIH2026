...
class MLProxyService {
    static async calculateRouteScore(data) {
        ...
        try {
            ...
            const response = await fetch(`${env_1.env.mlServiceUrl}/risk/route-score`, {
                method: 'POST',
            ...
            if (response.ok) {
                ...
                await redis_1.redisClient.set(cacheKey, result, { ex: 300 });
                return result;
            }
        }
        catch (err) {
    ...
    static async predictDisruption(districtId, weatherSnapshot) {
        try {
            const response = await fetch(`${env_1.env.mlServiceUrl}/risk/disruption-predict`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    static async suggestAlternateRoute(originDistrictId, destDistrictId) {
        return {
            primaryRoute: {
...
exports.MLProxyService = MLProxyService;
//# sourceMappingURL=ml-proxy.service.js.map