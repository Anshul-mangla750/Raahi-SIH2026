  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2 select-none">
      ...
      <div className="text-xs font-bold text-slate-500">
        Showing <span className="text-slate-900 font-extrabold">{startRecord}</span> to <span className="text-slate-900 font-extrabold">{endRecord}</span> of <span className="text-slate-900 font-extrabold">{totalItems}</span> vehicles
      </div>
