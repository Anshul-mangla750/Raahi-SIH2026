...
import { Truck, Navigation, PauseCircle, Wrench, WifiOff } from 'lucide-react';
import { vehiclesKPIData } from '../../data/vehiclesData';
  ...
  const getIcon = (iconName) => {
    switch (iconName) {
      ...
      case 'truck-idle':
        return <Truck className="w-6 h-6 stroke-[2.2]" />;
      case 'wrench':
        return <Wrench className="w-6 h-6 stroke-[2.2]" />;
      default:
        return <Truck className="w-6 h-6 stroke-[2.2]" />;
    }
  };
